...
Clearly, the G-NA procedure is the fastest, followed by the G-RNA method, which needs roughly 40% more time. But even the slowest approximate algorithm is more than two times as fast as G-DC-FFT.