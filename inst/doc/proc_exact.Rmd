...
Clearly, the DC-FFT procedure is the fastest, followed by the DC method, which needs roughly three times as much time here. RF and DFT-CF are almost five and six times, respectively, slower than DC-FFT, respectively (although RF has some advantages in precision, as stated before).
...
Clearly, the G-DC-FFT procedure is the fastest one. It outperforms both the G-DC and G-DFT-CF approaches. The latter one needs roughly four to five times as much time as G-DC. Generally, the computational speed advantage of the G-DC-FFT procedure increases with larger $n$ and $m$.